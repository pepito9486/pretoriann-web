...
const equiposCalistenia = [
  { name: "Anillas de Gimnasia", descripcion: "Uso: Muscle-ups, fondos, dominadas, trabajo de core y estabilidad.", imagen: "/img-equipo-calistenia/anillas-gimnasia.jpg" },
  { name: "Bandas de Resistencia", descripcion: "Uso: Dominadas asistidas, estiramientos, progresiones, ejercicios de resistencia muscular.", imagen: "/img-equipo-calistenia/bandas-resistencia.jpg" },
  ...
  { name: "Barra paralelas Baja", descripcion: "Uso: L-sits, planchas, fondos y flexiones, etc.", imagen: "/img-equipo-calistenia/barra-baja.jpg" },
  { name: "Barra de Dominadas", descripcion: "Uso: Trabaja principalmente espalda, bíceps y core.", imagen: "/img-equipo-calistenia/barra-dominadas.jpg" },
  ...
  { name: "Chaleco de Peso", descripcion: "Uso: Progresión de ejercicios como dominadas, flexiones y sentadillas.", imagen: "/img-equipo-calistenia/chalecos-peso.jpg" },
  ...
  { name: "Rodillo Abdominal", descripcion: "Uso: Desplazamientos hacia adelante para fortalecer el abdomen y la estabilidad.", imagen: "/img-equipo-calistenia/rodillo-abdominal.jpeg" },
  { name: "Soga de Saltar", descripcion: "Uso: Mejora el cardio y la coordinación.", imagen: "/img-equipo-calistenia/soga-saltar.webp" },
  { name: "Soporte para Flexiones", descripcion: "Uso: Aumenta la intensidad de las flexiones.", imagen: "/img-equipo-calistenia/soporte-flexiones.jpg" },
  { name: "Suspension TRX", descripcion: "Uso: Ejercicios de tracción, empuje y trabajo de core.", imagen: "/img-equipo-calistenia/suspension-trx.jpg" },
  { name: "Discos Deslizantes", descripcion: "Uso: Movimientos de core, flexiones y trabajo de estabilidad.", imagen: "/img-equipo-calistenia/discos-deslizantes.jpeg" },
  ...
  { name: "Lastres para Tobillos y Muñecas", descripcion: "Uso: Ideal para ejercicios de piernas, brazos, movimientos de core.", imagen: "/img-equipo-calistenia/pesas-tobillos.jpg" }
];
