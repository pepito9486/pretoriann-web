...
const Equiresistencia = forwardRef((props, ref) => {
  ...
  const equipos = [
    { name: "Bandas de Resistencia", uso: "Elevación lateral, sentadillas con banda, press de hombros, extensiones de tríceps y activación de glúteos.", imagen: "/img-equipo-resistencia/bandas-resistencia.jpg" },
    ...
    { name: "Pesas de Muñeca y Tobillo", uso: "Levantamiento de piernas, flexión de bíceps, elevación de rodillas y trabajo de glúteos.", imagen: "/img-equipo-resistencia/pesas-tobillos.jpg" },
    { name: "Bicicleta Estacionaria", uso: "Entrenamientos de intervalos (HIIT), pedaleo en colina y sesiones de resistencia continua.", imagen: "/img-equipo-resistencia/bicicleta.jpg" },
    { name: "Rueda de Abdominales (Ab Wheel)", uso: "Roll-outs, variaciones laterales para oblicuos y rodadas asistidas con banda.", imagen: "/img-equipo-resistencia/rodillo-abdominal.jpeg" },
    ...
    { name: "Bosu Ball", uso: "Sentadillas sobre el Bosu, planchas, flexiones y lunges en una sola pierna.", imagen: "/img-equipo-resistencia/pelota-bosu.jpg" },
    ...
    { name: "Saco de Arena (Sandbag)", uso: "Sentadillas con carga, cargadas de peso, press sobre cabeza y lunges.", imagen: "/img-equipo-resistencia/sacos-arena.jpg" }
  ];
