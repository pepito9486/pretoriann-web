...
const equipos = [
  ...
  { nombre: "Bandas de Resistencia", uso: "Asistencia para dominadas, press de hombro, pull-aparts, activación de glúteos.", imagen: "/img-equipo-funcional/bandas-resistencia.webp" },
  ...
  { nombre: "Suspencion TRX", uso: "Ejercicios de tracción, empuje y trabajo de core.", imagen: "/img-equipo-funcional/suspension-trx.webp" },
  { nombre: "Sandbags (Sacos de Arena)", uso: "Cargas de peso, clean and press, carry, fuerza y estabilidad.", imagen: "/img-equipo-funcional/sacos-arena.webp" },
  { nombre: "Pesas Rusas de Trineo (Sled)", uso: "Empuje de trineo, arrastre, velocidad y arrastre lateral.", imagen: "/img-equipo-funcional/pesas-trineo.webp" },
  { nombre: "Rodillo de Espuma (Foam Roller)", uso: "Ayuda en la recuperación y movilidad al aliviar la tensión muscular.", imagen: "/img-equipo-funcional/rodillos-masaje.webp" },
  ...
  { nombre: "Escalera de Agilidad", uso: "Zancadas, saltos, coordinación lateral, mejora la agilidad.", imagen: "/img-equipo-funcional/escalera-agilidad.webp" },
  ...
  { nombre: "Lastres para Tobillos y Muñecas", uso: "Ideal para ejercicios de piernas, brazos, movimientos de core.", imagen: "/img-equipo-funcional/pesas-tobillos.webp" }
];
